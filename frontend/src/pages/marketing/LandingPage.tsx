...
const tiers = [
  {
    ...
    limits: ['Up to 50 pigs', '1 user', 'No reports, Excel import, or AI assistant'],
  ...
  },
  {
    ...
    desc: 'Reports, imports, the AI assistant, and a small team for active commercial farms.',
    includes: ['Everything in Smallholder', 'All reports & exports', 'Mass Excel import', 'AI farm assistant', 'Up to 5 team members'],
